...
var squats = Exercise(name: "Squats", muscleGroups: ["Legs", "Back", "Stabilizers"], reps: 5, sets: 5)
...
var mondayRegimen = Regimen(dayOfWeek: "Monday", exercises: [squats])

var wednesdayRegimen = Regimen(dayOfWeek: "Wednesday", exercises: [pushUp])
